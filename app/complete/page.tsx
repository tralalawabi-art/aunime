      ...
      <main className="flex-1 pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full space-y-10">
        ...
        <div className="flex flex-col gap-2 border-b border-neutral-900 pb-5">
          <div className="text-xs text-neutral-500 flex items-center gap-1.5">
            ...
            <span>/</span>
            <span className="text-neutral-400">Complete Anime</span>
          </div>
          ...
          <p className="text-sm text-neutral-500 leading-relaxed max-w-xl">
            Daftar serial anime yang sudah selesai tayang (tamat). Sangat cocok untuk Anda yang ingin melakukan maraton nonton (binge-watching) dari episode pertama sampai akhir.
          </p>
        </div>
